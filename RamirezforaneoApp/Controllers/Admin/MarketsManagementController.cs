...
namespace RamirezforaneoApp.Controllers.Admin
{
    ...
    public class MarketsManagementController : Controller
    {
        ...
        // GET: MarketsManagement
        public async Task<IActionResult> Index()
        {
            var applicationDbContext = _context.Market.Include(m => m.Category).Include(m => m.ItemSeller);
            ViewData["ItemSellerId"] = new SelectList(_context.Users, "Id", "UserName");
            return View(await applicationDbContext.ToListAsync());
        }

        // GET: MarketsManagement/Details/5
        ...
        // GET: MarketsManagement/Delete/5
        ...
        // POST: MarketsManagement/Delete/5
