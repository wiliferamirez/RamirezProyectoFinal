...
namespace RamirezforaneoApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (IsForaneoCedula(Input.CedulaUser))
            {
                ModelState.AddModelError("Input.CedulaUser", "Sorry, you are not a foraneo.");
            }
        ...
        private bool IsForaneoCedula(string cedula)
        {
            return cedula.StartsWith("17");
        }
